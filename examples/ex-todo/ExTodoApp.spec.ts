...
describe('ExTodoApp', () => {
    ...
    it('should add items', () => {
        ...
        const items: Array<ExTodoItem> = Array.from(sandbox.querySelectorAll('ex-todo-item'))
    ...
    it('should clean items', () => {
        ...
        const itemsBefore: Array<ExTodoItem> = Array.from(sandbox.querySelectorAll('ex-todo-item'))
        ...
        const itemsAfter: Array<ExTodoItem> = Array.from(sandbox.querySelectorAll('ex-todo-item'))
