(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.cebForm = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"./form/index.js":17}],12:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().proto(Object.create(HTMLButtonElement.prototype)).extend('button').builders((0, _ceb.attribute)('type').value('button'), (0, _ceb.attribute)('meaning').value('default').listen(function (el, oldValue, newValue) {
    return (0, _jquery2.default)(el).removeClass('btn-' + oldValue).addClass('btn-' + newValue);
}), (0, _ceb.method)('createdCallback').invoke(function (el) {
    (0, _jquery2.default)(el).addClass('btn');
})).register('wui-button');

},{"../../es6/lib/ceb.js":9,"jquery":21}],13:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().builders((0, _ceb.template)('<label ceb-content></label>'), (0, _ceb.attribute)('inline').boolean().listen(function (el, oldValue, newValue) {
    if (newValue) {
        (0, _jquery2.default)(el).removeClass('radio').addClass('radio-inline');
    } else {
        (0, _jquery2.default)(el).addClass('radio').removeClass('radio-inline');
    }
})).register('wui-field-radio');

},{"../../es6/lib/ceb.js":9,"jquery":21}],14:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().builders((0, _ceb.template)('\n        <div class="form-group">\n            <label></label>\n            <span ceb-content></span>\n            <span class="help-block"></span>\n        </div>\n    '), (0, _ceb.delegate)((0, _ceb.attribute)('label')).to('label').property('textContent'), (0, _ceb.delegate)((0, _ceb.attribute)('help')).to('.help-block').property('textContent')).register('wui-field');

},{"../../es6/lib/ceb.js":9}],15:[function(require,module,exports){
'use strict';
...
function setElementValue(element, value) {
    if (element.type === 'time' || element.type === 'date') {
        ...
        element.value = (0, _utils.isNull)(value) || (0, _utils.isUndefined)(value) ? '' : value;
    }
}
...
function objectToForm(form, object) {
    var elements = (0, _utils.toArray)(form.querySelectorAll('[name]'));
    elements.forEach(function (element) {
        var path = element.name;
        var value = getObjectValue(object, path);
...
exports.default = (0, _ceb.ceb)().proto(Object.create(HTMLFormElement.prototype)).extend('form').builders((0, _ceb.attribute)('prevent-submit').boolean().listen(function (el, oldValue, newValue) {
    return el.setAttribute('onsubmit', newValue ? 'return false;' : '');
}), (0, _ceb.property)('valueAsObject').setter(objectToForm).getter(formToObject), (0, _ceb.property)('namedElements').getter(function (el) {
    return (0, _utils.toArray)(el.querySelectorAll('[name]'));
})).register('wui-form');

},{"../../es6/lib/ceb.js":9,"../../es6/lib/utils.js":10}],16:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().builders((0, _ceb.attribute)('glyphicon').listen(function (el, oldValue, newValue) {
    var $el = (0, _jquery2.default)(el);
    $el.removeClass('glyphicon glyphicon-' + oldValue);
    if (newValue) {
        $el.addClass('glyphicon glyphicon-' + newValue);
    }
}), (0, _ceb.attribute)('fa').listen(function (el, oldValue, newValue) {
    var $el = (0, _jquery2.default)(el);
...
},{"../../es6/lib/ceb.js":9,"jquery":21}],17:[function(require,module,exports){
'use strict';
...
require('./field-radio.js');

require('./form.js');

},{"./button.js":12,"./field-radio.js":13,"./field.js":14,"./form.js":15,"./icon.js":16,"./input.js":18,"./select.js":19,"./textarea.js":20}],18:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().proto(Object.create(HTMLInputElement.prototype)).extend('input').builders((0, _ceb.attribute)('type').listen(function (el, oldVal, newVal) {
    if (newVal === 'checkbox' || newVal === 'radio') {
        (0, _jquery2.default)(el).removeClass('form-control');
    } else {
        (0, _jquery2.default)(el).addClass('form-control');
    }
}), (0, _ceb.method)('createdCallback').invoke(function (el) {
    (0, _jquery2.default)(el).addClass('form-control');
})).register('wui-input');

},{"../../es6/lib/ceb.js":9,"jquery":21}],19:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().proto(Object.create(HTMLSelectElement.prototype)).extend('select').builders((0, _ceb.attribute)('type').value('text'), (0, _ceb.method)('createdCallback').invoke(function (el) {
    (0, _jquery2.default)(el).addClass('form-control');
})).register('wui-select');

},{"../../es6/lib/ceb.js":9,"jquery":21}],20:[function(require,module,exports){
'use strict';
...
exports.default = (0, _ceb.ceb)().proto(Object.create(HTMLTextAreaElement.prototype)).extend('textarea').builders((0, _ceb.method)('createdCallback').invoke(function (el) {
    (0, _jquery2.default)(el).addClass('form-control');
})).register('wui-textarea');

},{"../../es6/lib/ceb.js":9,"jquery":21}],21:[function(require,module,exports){
/*!
