...
describe("element", () => {
  ...
  it("should create element with inline class", () => {
    ...
    ElementBuilder.get(
      class extends HTMLElement implements IMyCustomElement {
  ...
  it("should extend an element", () => {
    ...
    const element = sandbox.appendChild(
      document.createElement("form", { is: tagName })
    ) as ElBuilderShouldExtendedHtmlElement
