 ...
 */
export type PurifyCommandHandlerOutputAsync<B = any,
    Es extends Array<Event> = []> = EitherAsync<Error, PurifyCommandHandlerOutput<B, Es>>
 ...
 * @param data the data
 */
export function createPurifyCommandHandlerOutput<B = any,
    Es extends Array<Event> = []>(data: Partial<PurifyCommandHandlerOutput<B, Es>> = {}): PurifyCommandHandlerOutput<B, Es> {
    return {
        result: Maybe.zero(),
        events: Maybe.zero(),
        ...data
