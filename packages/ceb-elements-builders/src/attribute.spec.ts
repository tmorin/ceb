...
describe("attribute", () => {
  ...
  it("should manage string and boolean values", () => {
    ...
    ElementBuilder.get(ShouldManageStringBooleanValues)
      .builder(
  ...
  it("should listen to values", () => {
    ...
    ElementBuilder.get(ShouldListenToValues)
      .builder(
  ...
  it("should get default value from HTML", () => {
    ...
    ElementBuilder.get(AttributeShouldGetDefaultFromHtml)
      .builder(
        AttributeBuilder.get("alt-string").default("a default value"),
        AttributeBuilder.get("alt-string-bis"),
    ...
    sandbox.innerHTML =
      '<attribute-should-get-default-from-html alt-string="a new string" alt-string-bis="a new bis string" alt-boolean=""/>'
