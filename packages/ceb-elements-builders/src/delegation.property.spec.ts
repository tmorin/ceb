  ...
  it("should delegate property", () => {
    ...
    ElementBuilder.get(TestElement)
      ...
      .builder(
        ...
        PropertyDelegationBuilder.get("disabled").to("input").boolean(),
        PropertyDelegationBuilder.get("altType").to("input").attribute("type"),
        PropertyDelegationBuilder.get("label").to("button").shadow().property("textContent")
      )
      .register()
