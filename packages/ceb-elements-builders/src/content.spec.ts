...
describe("content", () => {
  ...
  it("should set HTML content", () => {
    ...
    ElementBuilder.get(TestElement).name(tagName).builder(ContentBuilder.get(`<p><input></p>`)).register()
  ...
  it("should set HTML content by function", () => {
    ...
    ElementBuilder.get(TestElement)
      .name(tagName)
      .builder(ContentBuilder.get<TestElement>((el) => `<p>${el.name}</p>`))
      .register()
  ...
  it("should set shadow content", () => {
    ...
    ElementBuilder.get(TestElement).name(tagName).builder(ContentBuilder.get(`<p><input></p>`).shadow()).register()
    const element: TestElement = sandbox.appendChild(document.createElement(tagName))
    assert.ok(sandbox.querySelector(tagName))
