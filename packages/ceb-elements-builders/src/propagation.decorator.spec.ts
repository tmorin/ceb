...
describe("attribute_propagation.decorator", () => {
  ...
  it("should propagate the attribute mutations", () => {
    ...
    @AttributePropagationBuilder.get(AttributeBuilder.get("value").default("default value")).to("input").decorate()
    @AttributePropagationBuilder.get(AttributeBuilder.get("disabled").default(true)).to("input").decorate()
    @AttributePropagationBuilder.get(AttributeBuilder.get("alt-type").default("text"))
      .to("input")
      .property("type")
      .decorate()
    @AttributePropagationBuilder.get(AttributeBuilder.get("label").default("default label"))
      .to("button")
